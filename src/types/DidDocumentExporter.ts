...
import { DidResourceUri, DidServiceEndpoint, DidUri, EncryptionKeyType, VerificationKeyType } from './DidDocument.js'
...
export const verificationKeyTypesMap: Record<VerificationKeyType, ConformingDidDocumentKeyType> = {
...
export const encryptionKeyTypesMap: Record<EncryptionKeyType, ConformingDidDocumentKeyType> = {
...
export interface ConformingDidResolutionResult {
  ...
  didDocument?: Partial<ConformingDidDocument> & Pick<ConformingDidDocument, 'id'>
}
