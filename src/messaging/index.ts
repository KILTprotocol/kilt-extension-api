...
import { hexToU8a, stringToU8a, u8aToHex, u8aToString, isHex } from '@polkadot/util'
...
/**
   ...
   */
export function verifyDelegationStructure(delegationData: IDelegationData): void {
